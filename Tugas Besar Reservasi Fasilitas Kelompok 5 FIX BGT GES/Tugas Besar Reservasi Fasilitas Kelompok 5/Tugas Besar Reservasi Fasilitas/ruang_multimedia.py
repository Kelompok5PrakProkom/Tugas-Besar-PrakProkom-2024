...
facility_name = "Ruang Multimedia"
...
def send_email_with_invoice(recipient_email, invoice_filename):
    ...
    subject = "Invoice Reservasi Ruang Multimedia"
    body = "Berikut ini kami kirimkan invoice reservasi fasilitas Ruang Multimedia yang telah anda pesan."
